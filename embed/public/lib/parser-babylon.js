    ...
    function parse(t) {
      ...
      try {
        ...
        try {
          ...
          throw createError(r.message.replace(/ \(.*\)/, ''), {
            start: { line: r.loc.line, column: r.loc.column + 1 },
          })
        }
      }
      ...
      index = createCommonjsModule$$1(function(t, e) {
          ...
          return t < 65
            ...
            : t < 91 ||
                (t < 97
                  ...
                  : t < 123 ||
                      (t <= 65535
                        ? t >= 170 && j.test(String.fromCharCode(t))
                        : r(t, D)))
        }
        function n(t) {
          return t < 48
        ...
        function h(t, e) {
          for (var s = 1, i = 0; ; ) {
            F.lastIndex = i
            var r = F.exec(t)
            if (!(r && r.index < e)) return new U(s, e - i)
        ...
        function x(t, e) {
          return new (t && t.plugins ? v(t.plugins) : tt)(t, e)
        }
        function v(t) {
        ...
        var b = {
          ...
          k = function t(e) {
            var s = arguments.length > 1 && void 0 !== arguments[1]
              ? arguments[1]
              : {}
            g(this, t), (this.label = e), (this.keyword =
              s.keyword), (this.beforeExpr = !!s.beforeExpr), (this.startsExpr = !!s.startsExpr), (this.rightAssociative = !!s.rightAssociative), (this.isLoop = !!s.isLoop), (this.isAssign = !!s.isAssign), (this.prefix = !!s.prefix), (this.postfix = !!s.postfix), (this.binop =
              s.binop || null), (this.updateContext = null)
          },
          E = (function(t) {
            function e(s) {
              var i = arguments.length > 1 && void 0 !== arguments[1]
                ? arguments[1]
                : {}
              return g(this, e), (i.keyword = s), P(this, t.call(this, s, i))
            }
            return w(e, t), e
          })(k),
          T = (function(t) {
            function e(s, i) {
              return g(this, e), P(
                this,
                t.call(this, s, { beforeExpr: A, binop: i })
              )
            }
            return w(e, t), e
          })(k),
          C = {
            ...
            eof: new k('eof'),
            bracketL: new k('[', { beforeExpr: A, startsExpr: !0 }),
            bracketR: new k(']'),
            braceL: new k('{', { beforeExpr: A, startsExpr: !0 }),
            braceBarL: new k('{|', { beforeExpr: A, startsExpr: !0 }),
            braceR: new k('}'),
            braceBarR: new k('|}'),
            parenL: new k('(', { beforeExpr: A, startsExpr: !0 }),
            parenR: new k(')'),
            comma: new k(',', { beforeExpr: A }),
            semi: new k(';', { beforeExpr: A }),
            colon: new k(':', { beforeExpr: A }),
            doubleColon: new k('::', { beforeExpr: A }),
            dot: new k('.'),
            question: new k('?', { beforeExpr: A }),
            arrow: new k('=>', { beforeExpr: A }),
            template: new k('template'),
            ellipsis: new k('...', { beforeExpr: A }),
            backQuote: new k('`', { startsExpr: !0 }),
            dollarBraceL: new k('${', { beforeExpr: A, startsExpr: !0 }),
            at: new k('@'),
            hash: new k('#'),
            eq: new k('=', { beforeExpr: A, isAssign: !0 }),
            assign: new k('_=', { beforeExpr: A, isAssign: !0 }),
          ...
          N = {
            break: new E('break'),
            case: new E('case', { beforeExpr: A }),
            catch: new E('catch'),
            continue: new E('continue'),
            debugger: new E('debugger'),
            default: new E('default', { beforeExpr: A }),
            do: new E('do', { isLoop: !0, beforeExpr: A }),
            else: new E('else', { beforeExpr: A }),
            finally: new E('finally'),
            for: new E('for', { isLoop: !0 }),
            function: new E('function', { startsExpr: !0 }),
            if: new E('if'),
            return: new E('return', { beforeExpr: A }),
            switch: new E('switch'),
            throw: new E('throw', { beforeExpr: A }),
            try: new E('try'),
            var: new E('var'),
            let: new E('let'),
            const: new E('const'),
            ...
            with: new E('with'),
            new: new E('new', { beforeExpr: A, startsExpr: !0 }),
            this: new E('this', { startsExpr: !0 }),
            super: new E('super', { startsExpr: !0 }),
            class: new E('class'),
            extends: new E('extends', { beforeExpr: A }),
            export: new E('export'),
            import: new E('import', { startsExpr: !0 }),
            yield: new E('yield', { beforeExpr: A, startsExpr: !0 }),
            null: new E('null', { startsExpr: !0 }),
            true: new E('true', { startsExpr: !0 }),
            false: new E('false', { startsExpr: !0 }),
            in: new E('in', { beforeExpr: A, binop: 7 }),
            instanceof: new E('instanceof', { beforeExpr: A, binop: 7 }),
            typeof: new E('typeof', {
              beforeExpr: A,
              prefix: !0,
              startsExpr: !0,
            }),
            void: new E('void', { beforeExpr: A, prefix: !0, startsExpr: !0 }),
            delete: new E('delete', {
              beforeExpr: A,
              prefix: !0,
              startsExpr: !0,
        ...
        var D = [
          ...
          q = function t(e, s, i, r) {
            g(
              this,
              t
            ), (this.token = e), (this.isExpr = !!s), (this.preserveSpace = !!i), (this.override = r)
          },
          V = {
            braceStatement: new q('{', !1),
            braceExpression: new q('{', !0),
            templateQuasi: new q('${', !0),
            parenStatement: new q('(', !1),
            parenExpression: new q('(', !0),
            template: new q('`', !0, !0, function(t) {
              return t.readTmplToken()
            }),
            functionExpression: new q('function', !0),
          }
        ;(C.parenR.updateContext = C.braceR.updateContext = function() {
          if (1 !== this.state.context.length) {
            var t = this.state.context.pop()
            t === V.braceStatement && this.curContext() === V.functionExpression
          ...
          ;(this.state.exprAllowed = !1), (t !== C._let &&
            t !== C._const &&
            t !== C._var) ||
            (M.test(this.input.slice(this.state.end)) &&
              (this.state.exprAllowed = !0))
        }), (C.braceL.updateContext = function(t) {
          this.state.context.push(
            this.braceIsBlock(t) ? V.braceStatement : V.braceExpression
          ), (this.state.exprAllowed = !0)
          ...
          this.state.context.push(
            e ? V.parenStatement : V.parenExpression
          ), (this.state.exprAllowed = !0)
        }), (C.incDec.updateContext = function() {}), (C._function.updateContext = function() {
          this.curContext() !== V.braceStatement &&
            this.state.context.push(
              V.functionExpression
            ), (this.state.exprAllowed = !1)
        }), (C.backQuote.updateContext = function() {
          this.curContext() === V.template
            ? this.state.context.pop()
            : this.state.context.push(V.template), (this.state.exprAllowed = !1)
        })
        var U = function t(e, s) {
                ...
                if (!('Program' === t.type && t.body.length > 0)) {
                  ...
                  if (
                    (
                      ...
                      s &&
                        ...
                        p(this.state.leadingComments).start >= t.start &&
                  ...
                  if (i) {
                    ...
                    if (p(this.state.leadingComments).end <= t.start) {
                      ...
                      ;(t.leadingComments = 0 === h.length ? null : h), 0 ===
          ...
          W = (function() {
            ...
            return (t.prototype.init = function(t, e) {
              ;(this.strict =
                !1 !== t.strictMode &&
                'module' ===
                  t.sourceType), (this.input = e), (this.potentialArrowAt = -1), (this.inMethod = this.inFunction = this.inGenerator = this.inAsync = this.inPropertyName = this.inType = this.inClass = this.inClassProperty = this.noAnonFunctionType = !1), (this.labels = []), (this.decorators = []), (this.tokens = []), (this.comments = []), (this.trailingComments = []), (this.leadingComments = []), (this.commentStack = []), (this.pos = this.lineStart = 0), (this.curLine =
          ...
          G = function t(e) {
            g(this, t), (this.type = e.type), (this.value =
              e.value), (this.start = e.start), (this.end =
              e.end), (this.loc = new X(e.startLoc, e.endLoc))
          },
          K = (function(t) {
            function e() {
              return g(this, e), P(this, t.apply(this, arguments))
            ...
            (function(t) {
              function e(s, i) {
                ...
                return (r.state = new W()), r.state.init(s, i), r
              }
              return w(e, t), (e.prototype.next = function() {
                ...
                for (
                  var i = void 0;
                  (i = F.exec(this.input)) && i.index < this.state.pos;
                  ...
                  switch (t) {
                    ...
                    default:
                      if (
                        !(
                          (t > 8 && t < 14) ||
                          (t >= 5760 && B.test(String.fromCharCode(t)))
                        )
                      )
                        break t
                      ++this.state.pos
                ...
                var n = this.input.slice(e, this.state.pos),
                  o = void 0
                return i
                  ? (o = parseFloat(n))
                  : s && 1 !== n.length
                    ? this.state.strict
                      ? this.raise(e, 'Invalid number')
                      : (o = /[89]/.test(n) ? parseInt(n, 10) : parseInt(n, 8))
                    : (o = parseInt(n, 10)), this.finishToken(C.num, o)
                ...
                return !this.state.containsEsc &&
                  this.isKeyword(t) &&
                  (e = N[t]), this.finishToken(e, t)
              }), (e.prototype.braceIsBlock = function(t) {
                if (t === C.colon) {
                  var e = this.curContext()
                  if (e === V.braceStatement || e === V.braceExpression)
                    return !e.isExpr
                }
                return t === C._return
                  ? M.test(
          ...
          Q = (function() {
            function t(e, s, i) {
              g(this, t), (this.type =
                ''), (this.start = s), (this.end = 0), (this.loc = new X(
                i
              )), e && e.options.ranges && (this.range = [s, 0]), e &&
                e.filename &&
          ...
          tt = (function(t) {
            function e(i, r) {
              g(this, e), (i = s(i))
              var a = P(this, t.call(this, i, r))
              return (a.options = i), (a.inModule =
                'module' ===
                a.options.sourceType), (a.input = r), (a.plugins = l(
                a.options.plugins
              )), (a.filename = i.sourceFilename), 0 === a.state.pos &&
                '#' === a.input[0] &&
                '!' === a.input[1] &&
                a.skipLineComment(2), a
            }
            ...
            (function(t) {
              ...
              return w(e, t), (e.prototype.parseTopLevel = function(t, e) {
                return (e.sourceType = this.options.sourceType), this.parseBlockBody(
                  ...
                  e,
                  'Program'
                )), (t.comments = this.state.comments), (t.tokens = this.state.tokens), this.finishNode(
                  t,
                  'File'
                )
                ...
                var t = this.startNode()
                return this.next(), (t.expression = this.parseMaybeAssign()), this.finishNode(
                  t,
                  'Decorator'
                )
                ...
                this.next(), this.state.labels.push(H)
                var e = !1
                if (
                  (
                ...
                var e = (t.cases = [])
                this.expect(C.braceL), this.state.labels.push($)
                ...
                if (
                  ...
                  this.next(), this.expect(
                    C.parenL
                  ), (e.param = this.parseBindingAtom()), this.checkLVal(
                    e.param,
                    !0,
                    Object.create(null),
                    'catch clause'
                ...
                return (t.guardedHandlers = Y), (t.finalizer = this.eat(
                  C._finally
                )
                  ? this.parseBlock()
                  : null), t.handler ||
                ...
                for (
                  ...
                  n ||
                    !this.state.containsOctal ||
                    h ||
                    (h = this.state.octalPosition)
                  var p = this.parseStatement(!0, s)
                  if (e && !n && this.isValidDirective(p)) {
                    var c = this.stmtToDirective(p)
                    a.push(c), void 0 === o &&
                      'use strict' === c.value.value &&
                      (
                        (o = this.state.strict),
                        this.setStrict(!0),
                        h && this.raise(h, 'Octal literal in strict mode')
                      )
                  } else (n = !0), r.push(p)
                }
                ...
                return (this.state.inMethod = !1), this.initFunction(
                  ...
                  t,
                  s
                ), (this.state.inMethod = a), this.finishNode(
                  t,
                ...
                ;(this.state.strict = !0), (this.state.inClass = !0)
                var s = !1,
                  i = [],
                  r = this.startNode()
                for (
                  ...
                  if (this.eat(C.semi))
                    ...
                    if (
                      ...
                      this.next(), this.parsePropertyName(a), r.body.push(
                        this.parsePrivateClassProperty(a)
                      )
                    else {
                      if (
                        (
                        ...
                        if (this.isClassMethod()) {
                          ;(a.kind =
                            'method'), (a.computed = !1), (a.key = n), this.parseClassMethod(
                            r,
                            a,
                            !1,
                            !1
                        ...
                        if (this.isClassProperty()) {
                          ;(a.computed = !1), (a.key = n), r.body.push(
                      ...
                      if (this.eat(C.star))
                        (a.kind = 'method'), this.parsePropertyName(
                          a
                          ...
                          !a.static ||
                          ('prototype' !== a.key.name &&
                            'prototype' !== a.key.value) ||
                          this.raise(
                            a.key.start,
                            'Classes may not have static property named prototype'
                          ), this.parseClassMethod(r, a, !0, !1)
                      else {
                        var o = this.match(C.name),
                        ...
                        if (
                          ...
                          this.isNonstaticConstructor(a)
                            ...
                            : (a.kind = 'method'), this.parseClassMethod(
                            r,
                            a,
                            !1,
                            !1
                          ...
                          this.isNonstaticConstructor(a) &&
                            ...
                            ), r.body.push(this.parseClassProperty(a))
                        else if (
                          o &&
                          'async' === h.name &&
                          ...
                          !o ||
                            ...
                            : (
                                ...
                                this.parseClassMethod(r, a, !1, !1),
                                this.checkGetterSetterParamCount(a)
                              )
                      }
                    }
                  }
                ...
                i.length &&
                  ...
                  r,
                  'ClassBody'
                )), (this.state.inClass = !1), (this.state.strict = e)
                ...
                return t.typeAnnotation ||
                  ...
                  ? (
                      e || this.raise(this.state.start, s),
                      this.next(),
                ...
                this.parseMethod(e, s, i), t.body.push(
                  this.finishNode(e, 'ClassMethod')
                )
                ...
                if ((this.eat(C._export), this.match(C.star))) {
                  ...
                  if (
                    ...
                    return this.parseExportFrom(t, !0), this.finishNode(
                      t,
                      'ExportAllDeclaration'
                    )
                  ;(e.exported = this.parseIdentifier(!0)), (t.specifiers = [
                  ...
                  var i = [this.finishNode(s, 'ExportDefaultSpecifier')]
                  if (
                    (
                      (t.specifiers = i),
                    ...
                    this.expect(C.star), this.expectContextual(
                      'as'
                    ), (r.exported = this.parseIdentifier()), i.push(
                      this.finishNode(r, 'ExportNamespaceSpecifier')
                    )
                  ...
                  if (this.eat(C._default)) {
                    ...
                    return this.eat(C._function)
                      ? (a = this.parseFunction(a, !0, !1, !1, !0))
                      : this.isContextual('async') &&
                          this.lookahead().type === C._function
                        ? (
                            this.eatContextual('async'),
                            this.eat(C._function),
                            (a = this.parseFunction(a, !0, !1, !0, !0))
                          )
                        : this.match(C._class)
                          ? (a = this.parseClass(a, !0, !0))
                          : (
                              (n = !0),
                ...
                return this.eat(C._import), this.match(C.string)
              ...
              (function(t) {
                ...
                return w(e, t), (e.prototype.checkPropClash = function(t, e) {
                ...
                }), (e.prototype.parseConditional = function(t, e, s, i) {
                  if (this.eat(C.question)) {
                    var r = this.startNodeAt(s, i)
                    return (r.test = t), (r.consequent = this.parseMaybeAssign()), this.expect(
                      C.colon
                  ...
                  if (this.state.type.prefix) {
                    ...
                    return (e.argument = this.parseMaybeUnary()), this.addExtra(
                      e,
                    ...
                    ), t && t.start && this.unexpected(t.start), s
                      ? this.checkLVal(
                          e.argument,
                          void 0,
                          void 0,
                  ...
                  for (
                    ...
                    ;(o.operator = this.state.value), (o.prefix = !1), (o.argument = n), this.checkLVal(
                      n,
                      void 0,
                      void 0,
                      'postfix operation'
                    ), this.next(), (n = this.finishNode(o, 'UpdateExpression'))
                  }
                  return n
                  ...
                  for (;;) {
                    if (!i && this.eat(C.doubleColon)) {
                      ...
                      return (r.object = t), (r.callee = this.parseNoCallExpr()), this.parseSubscripts(
                    ...
                    if (this.eat(C.dot)) {
                      ...
                      ;(a.object = t), (a.property = this.hasPlugin(
                        'classPrivateProperties'
                      )
                        ? this.parseMaybePrivateName()
                        : this.parseIdentifier(
                            !0
                          )), (a.computed = !1), (t = this.finishNode(
                        a,
                        'MemberExpression'
                      ))
                    } else if (this.eat(C.bracketL)) {
                      var n = this.startNodeAt(e, s)
                      ;(n.object = t), (n.property = this.parseExpression()), (n.computed = !0), this.expect(
                        C.bracketR
                      ...
                      if (
                        ...
                        p &&
                          ...
                          this.raise(p.start, '... is not allowed in import()')
                      }
                      if (
                        (
                      ...
                      ;(c.tag = t), (c.quasi = this.parseTemplate(
                        !0
                  ...
                  switch (this.state.type) {
                    ...
                    case C._import:
                      return this.hasPlugin('dynamicImport') ||
                        this.unexpected(), (s = this.startNode()), this.next(), this.match(
                        C.parenL
                      ) || this.unexpected(null, C.parenL), this.finishNode(
                        s,
                        'Import'
                      )
                    case C._this:
                    ...
                    case C._true:
                    case C._false:
                      return (s = this.startNode()), (s.value = this.match(
                        C._true
                      )), this.next(), this.finishNode(s, 'BooleanLiteral')
                    case C.parenL:
                  ...
                  if (this.eat(C.hash)) {
                    var t = this.startNode()
                    return (t.name = this.parseIdentifier(!0)), this.finishNode(
                      t,
                      'PrivateName'
                    )
                  }
                  ...
                  return (t.meta = e), (t.property = this.parseIdentifier(
                    !0
                  )), t.property.name !== s &&
                    this.raise(
                      t.property.start,
                  ...
                  if (
                    ...
                    for (
                      ...
                      if (v) {
                        ...
                        if ((b = x.next()).done) break
                        g = b.value
                      }
                      var w = g
                      w.extra &&
                        w.extra.parenthesized &&
                        this.unexpected(w.extra.parenStart)
                    }
                  ...
                  return n.length ||
                    ...
                    ? (
                        ...
                        this.finishNodeAt(i, 'SequenceExpression', f, m)
                      )
                    : (i = n[0]), this.addExtra(
                    i,
                    'parenthesized',
                  ...
                  return (t.callee = this.parseNoCallExpr()), this.eat(C.parenL)
                    ? (
                        (t.arguments = this.parseExprList(C.parenR)),
                        this.toReferencedList(t.arguments)
                      )
                    : (t.arguments = []), this.finishNode(t, 'NewExpression')
                    ...
                    if (
                      ...
                      if (
                        (
                          ...
                          (o.type = t ? 'RestElement' : 'SpreadElement'),
                          t &&
                            this.toAssignable(o.argument, !0, 'object pattern'),
                          a.properties.push(o),
                          !t
                        )
                      )
                  ...
                  if (this.eat(C.bracketL))
                    ...
                    ;(this.state.inPropertyName = !0), (t.key = this.match(
                      C.num
                    ) || this.match(C.string)
                      ? this.parseExprAtom()
                      : this.parseIdentifier(
                  ...
                  return (this.state.inMethod =
                    t.kind || !0), this.initFunction(t, s), this.expect(
                    C.parenL
                  ), (t.params = this.parseBindingList(
                    C.parenR
                  )), (t.generator = !!e), this.parseFunctionBody(
                    t
                  ), (this.state.inMethod = i), t
                  ...
                  if (
                    ...
                    for (
                      ...
                      o &&
                        ...
                        ), this.checkLVal(m, !0, p, 'function parameter list')
                    }
                    this.state.strict = c
                  }
                  ...
                  return t ||
                    ...
                    ), (e.loc.identifierName =
                    e.name), this.next(), this.finishNode(e, 'Identifier')
                ...
                (function(t) {
                  ...
                  return w(e, t), (e.prototype.toAssignable = function(
                    t,
                    e,
                    s
                  ) {
                    ...
                    for (var s = [], i = !0; !this.eat(t); ) {
                      if (
                        ...
                        r.length &&
                          (a.decorators = r), this.parseAssignableListItemTypes(
                          a
                        ), s.push(
                          this.parseMaybeDefault(a.start, a.loc.start, a)
                        )
                      }
                    }
                    return s
          ...
          et = function et(t) {
            return (function(t) {
              ...
              return w(e, t), (e.prototype.estreeParseRegExpLiteral = function(
                t
              ) {
                var e = t.pattern,
                  s = t.flags,
              ...
              }), (e.prototype.checkLVal = function(e, s, i) {
                var r,
                  a = this
                switch (e.type) {
                  case 'ObjectPattern':
                  ...
                  default:
                    ...
                    (r = t.prototype.checkLVal).call.apply(
                      r,
                      [this, e, s, i].concat(o)
                    )
                }
              ...
              }), (e.prototype.parseBlockBody = function(e) {
                for (
                  var s,
                    i = this,
                    r = arguments.length,
                ...
                ;(s = t.prototype.parseBlockBody).call.apply(
                  s,
                  [this, e].concat(a)
                )
                var o = e.directives.map(function(t) {
                  return i.directiveToStmt(t)
                })
                ;(e.body = o.concat(e.body)), delete e.directives
              }), (e.prototype.parseClassMethod = function(e) {
                for (
                  var s,
                    i = arguments.length,
                    r = Array(i > 1 ? i - 1 : 0),
                ...
                ;(s = t.prototype.parseClassMethod).call.apply(
                  s,
                  [this, e].concat(r)
                )
                var n = e.body
                n[n.length - 1].type = 'MethodDefinition'
              }), (e.prototype.parseExprAtom = function() {
                var e
                switch (this.state.type) {
                  case C.regexp:
                  ...
                  default:
                    for (
                      var s = arguments.length, i = Array(s), r = 0;
                      r < s;
                      r++
                    ) {
                      i[r] = arguments[r]
                    }
                    return (e = t.prototype.parseExprAtom).call.apply(
                      e,
                      [this].concat(i)
                    )
                }
              }), (e.prototype.parseLiteral = function() {
                for (
                ...
                var a = (e = t.prototype.parseLiteral).call.apply(
                  e,
                  [this].concat(i)
                )
                return (a.raw = a.extra.raw), delete a.extra, a
              }), (e.prototype.parseMethod = function(e) {
                var s,
                  i = this.startNode()
                i.kind = e.kind
                for (
                ...
                return (i = (s = t.prototype.parseMethod).call.apply(
                  s,
                  [this, i].concat(a)
                )), delete i.kind, (e.value = this.finishNode(
                  i,
                  'FunctionExpression'
                )), e
              }), (e.prototype.parseObjectMethod = function() {
                for (
                  var e, s = arguments.length, i = Array(s), r = 0;
                  r < s;
                  r++
                ...
                var a = (e = t.prototype.parseObjectMethod).call.apply(
                  e,
                  [this].concat(i)
                )
                return a &&
                ...
                var a = (e = t.prototype.parseObjectProperty).call.apply(
                  e,
                  [this].concat(i)
                )
                return a && ((a.kind = 'init'), (a.type = 'Property')), a
              }), (e.prototype.toAssignable = function(e, s) {
                for (
                  var i,
                    r = arguments.length,
                    a = Array(r > 2 ? r - 2 : 0),
                ...
                if (u(e))
                  return this.toAssignable.apply(
                    this,
                    [e.value, s].concat(a)
                  ), e
                ...
                return (i = t.prototype.toAssignable).call.apply(
                  i,
                  [this, e, s].concat(a)
                )
              }), e
          ...
          rt = function rt(t) {
            return (function(t) {
              ...
              return w(e, t), (e.prototype.flowParseTypeInitialiser = function(
                t
              ) {
                ...
                return st.indexOf(this.state.value) > -1 &&
                  this.raise(
                    this.state.start,
                ...
                var e = this.startNodeAt(t.start, t.loc)
                ...
                switch (this.state.type) {
                  ...
                  case C._this:
                    return (s.value = this.match(
                      C._this
                    )), this.next(), this.finishNode(s, 'ThisTypeAnnotation')
                  case C.star:
                ...
                if (this.match(C.colon) && !s) {
                  ...
                  ;(i.typeAnnotation = r[0]), (e.predicate =
                    r[1]), (e.returnType = i.typeAnnotation
              ...
              }), (e.prototype.parseClassId = function(e) {
                for (
                  var s,
                    i = arguments.length,
                    r = Array(i > 1 ? i - 1 : 0),
                ...
                ;(s = t.prototype.parseClassId).call.apply(
                  s,
                  [this, e].concat(r)
                ), this.isRelational('<') &&
                ...
                return t
              }), (e.prototype.parseExprListItem = function() {
                for (
                  var e,
                    s = this.startNode(),
                    i = arguments.length,
                ...
                var n = (e = t.prototype.parseExprListItem).call.apply(
                  e,
                  [this].concat(r)
                )
                return this.match(C.colon)
                  ...
                  : n
              }), (e.prototype.checkLVal = function(e) {
                if ('TypeCastExpression' !== e.type) {
                  ...
                  return (s = t.prototype.checkLVal).call.apply(
                    s,
                    [this, e].concat(r)
                  )
                }
              ...
              }), (e.prototype.parseClassMethod = function(e, s) {
                var i
                s.variance &&
                  this.unexpected(
                    s.variance.start
                ...
                ;(i = t.prototype.parseClassMethod).call.apply(
                  i,
                  [this, e, s].concat(a)
                )
              }), (e.prototype.parseClassSuper = function(e, s) {
                if (
                  (
                    t.prototype.parseClassSuper.call(this, e, s),
                    e.superClass &&
                      this.isRelational('<') &&
                  ...
                  do {
                    var r = this.startNode()
                    ;(r.id = this.parseIdentifier()), this.isRelational('<')
                      ? (r.typeParameters = this.flowParseTypeParameterInstantiation())
                      : (r.typeParameters = null), i.push(
                      this.finishNode(r, 'ClassImplements')
                    )
                  } while (this.eat(C.comma))
                }
                ...
                ;(s = t.prototype.parseObjPropValue).call.apply(
                  s,
                  [this, e].concat(a)
                ), i && ((e.value || e).typeParameters = i)
              }), (e.prototype.parseAssignableListItemTypes = function(t) {
                return this.eat(C.question) && (t.optional = !0), this.match(
                  C.colon
                ) &&
                ...
                for (
                  var e, s = null, i = arguments.length, r = Array(i), a = 0;
                  a < i;
                  a++
                ) {
                  r[a] = arguments[a]
                ...
                if (C.jsxTagStart && this.match(C.jsxTagStart)) {
                  ...
                  try {
                    ...
                    ;(this.state = n), (this.state.context.length -= 2), (s = t)
                  }
                }
                if (null != s || this.isRelational('<')) {
                  ...
                  try {
                    var c
                    ;(p = this.flowParseTypeParameterDeclaration()), ((h = (c =
                      t.prototype.parseMaybeAssign).call.apply(
                      c,
                      [this].concat(r)
                    )).typeParameters = p), this.resetStartLocationFromNode(
                      h,
                      p
                    )
                  } catch (t) {
                  ...
                  if ('ArrowFunctionExpression' === h.type) return h
                  if (null != s) throw s
                  this.raise(
                    p.start,
                ...
                return (e = t.prototype.parseMaybeAssign).call.apply(
                  e,
                  [this].concat(r)
                )
        ...
        ;(V.j_oTag = new q(
          '<tag',
          !1
        )), (V.j_cTag = new q('</tag', !1)), (V.j_expr = new q('<tag>...</tag>', !0, !0)), (C.jsxName = new k('jsxName')), (C.jsxText = new k('jsxText', { beforeExpr: !0 })), (C.jsxTagStart = new k('jsxTagStart', { startsExpr: !0 })), (C.jsxTagEnd = new k('jsxTagEnd')), (C.jsxTagStart.updateContext = function() {
          this.state.context.push(V.j_expr), this.state.context.push(
            V.j_oTag
          ), (this.state.exprAllowed = !1)
        }), (C.jsxTagEnd.updateContext = function(t) {
          var e = this.state.context.pop()
          ;(e === V.j_oTag && t === C.slash) || e === V.j_cTag
            ? (
                this.state.context.pop(),
                (this.state.exprAllowed = this.curContext() === V.j_expr)
              )
            : (this.state.exprAllowed = !0)
        })
        var ht = function ht(t) {
          return (function(t) {
            ...
            return w(e, t), (e.prototype.jsxReadToken = function() {
              ...
              if (s === V.j_expr) return this.jsxReadToken()
              if (s === V.j_oTag || s === V.j_cTag) {
                if (a(e)) return this.jsxReadWord()
                if (62 === e)
                  return ++this.state.pos, this.finishToken(C.jsxTagEnd)
                if ((34 === e || 39 === e) && s === V.j_oTag)
              ...
              if (this.match(C.braceL)) {
                var s = this.curContext()
                s === V.j_oTag
                  ? this.state.context.push(V.braceExpression)
                  : s === V.j_expr
                    ? this.state.context.push(V.templateQuasi)
        ...
        ;(Z.estree = et), (Z.flow = rt), (Z.jsx = ht)
        var pt = {}
        ;(e.parse = m), (e.parseExpression = y), (e.tokTypes = C)
      })
