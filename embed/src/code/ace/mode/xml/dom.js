...
Document.prototype = {
  ...
  insertBefore: function(newChild, refChild) {
    ...
    return _insertBefore(
      ...
      newChild,
      refChild
    ), (newChild.ownerDocument = this), newChild
  },
  removeChild: function(oldChild) {
