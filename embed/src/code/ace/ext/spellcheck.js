...
export var contextMenuHandler = function(e) {
  var host = e.target
...
$_____config.defineOptions(Editor.prototype, 'editor', {
  spellcheck: {
    set: function(val) {
      ...
      text.spellcheck = !!val
      if (!val) this.removeListener('nativecontextmenu', contextMenuHandler)
      else this.on('nativecontextmenu', contextMenuHandler)
    },
    value: true,
  },
})
